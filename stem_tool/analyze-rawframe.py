...
if __name__ == "__main__":
    ...
    output_root = os.path.join("outputs/zwl_raw", gas_category)
    raw_frame_dir = "data_cus/zwl_raw_resize512_878/group_0/frame"
    ...
    tracker = GasTracker(
        json_dir="outputs/zwl_raw_resize512_878-sam3/group_0/mark",
